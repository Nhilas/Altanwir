...
**Source:** silver-merged.md §Engineering patterns → CDF incremental, line 151. adr-triage.md #23.
...
**Source:** silver-merged.md §Engineering patterns → CDF incremental, line 153. [ADR-002](../adrs/adr-002-cdf-incremental-audit-warehouse.md).
...
**Source:** silver-merged.md §Engineering patterns → CDF incremental, line 149.
...
**Source:** silver-merged.md §Data model → Silver engineered columns, line 73.
...
**Source:** silver-merged.md §Engineering patterns → CDF incremental, line 158.
