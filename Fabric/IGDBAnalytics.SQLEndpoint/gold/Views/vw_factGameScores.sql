...
, tiered_game_scores as (
    select
        *
        , case when smoothedIGDBRating is not null then
            case
        ...
        else NULL end as IGDBRatingTier        
        , case when weightedSentimentRating is not null then
            case
        ...
        else NULL end as weightedSentimentTier
        , case when weightedVoteRating is not null then
            case
        ...
        else NULL end as weightedVoteTier        
        , case
            when totalReviews >= 500 then
                case
            ...
            when totalReviews between 50 and 499 then
                case
            ...
            when totalReviews between 10 and 49 then
                case
            ...
            when totalReviews < 10 then 'Insufficient Data'
        else NULL end as steamRatingLabel
